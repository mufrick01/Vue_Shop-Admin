<template>
  <div class="bg-white px-5 py-2 rounded shadow-lg">
      ...
      <div class="shadow overflow-hidden rounded border-b border-gray-200">
        <table class="min-w-full bg-white">
          ...
          <tbody class="text-gray-700">
            <tr v-for="(product, index) in products" :key="product.id" :class="{ 'bg-gray-100': index % 2 === 0 }">
              ...
              <td class="text-left py-3 px-4">
                <span class="bg-blue-200 text-blue-600 py-1 px-3 rounded-full text-xs text-center">${{ product.price
                  }}</span>
              </td>
              <td class="text-left py-3 px-4">
                {{ product.sizes.join(', ') }}
